    ...
    <div className="min-h-full bg-gray-50 text-gray-900">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <header className="mb-10 border-b border-gray-200 pb-6">
          <p className="mb-2 inline-block rounded-full border border-gray-300 px-3 py-1 text-xs text-gray-500">
            Legal
          </p>
          ...
          <p className="mt-2 text-sm text-gray-500">
            App Name:{" "}
            <span className="font-medium text-gray-900">Make It Editable</span>
        ...
        <nav
          ...
          className="mb-10 grid gap-2 rounded-2xl border border-gray-200 bg-white p-4 md:grid-cols-2"
        >
          {[
        ...
        <div className="prose prose-gray max-w-none [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:text-gray-600 [&_li]:text-gray-600 [&_a]:text-gray-900 [&_a]:underline">
          {/* 1. Introduction */}
